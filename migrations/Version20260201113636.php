 ...
 */
final class Version20260201113636 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE palabra ADD palabra VARCHAR(255) NOT NULL, ADD deleted_at DATETIME DEFAULT NULL, CHANGE texto definicion LONGTEXT NOT NULL');
        $this->addSql('ALTER TABLE usuario ADD roles JSON DEFAULT NULL, ADD is_blocked TINYINT DEFAULT 0');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE palabra DROP palabra, DROP deleted_at, CHANGE definicion texto LONGTEXT NOT NULL');
